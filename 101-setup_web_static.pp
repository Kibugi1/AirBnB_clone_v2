# puppet script that automates  the configuration of Nginx in my servers
...
exec {'create the first directory':
  provider => shell,
  command  => 'sudo mkdir -p /data/web_static/releases/test/',
  before   => Exec['create second directory'],
}

exec {'create a second directory':
  provider => shell,
...
exec {'content into html':
  provider => shell,
  command  => 'echo "Hello awesome person! WElcome to my site!" | sudo tee /data/web_static/releases/test/index.html',
